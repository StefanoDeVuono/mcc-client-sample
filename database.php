...
// connect from local
shell_exec("ssh -f -L 3307:192.168.100.59:3306 fon@rcs.mycallcloud.com sleep 60 >> logfile"); // V5 remotely
$db = mysqli_connect('127.0.0.1', 'cron', '1234', 'asteriskrcs', 3307); // V5 remotely
...
// *************************************************
//	User Authorization
$PHP_AUTH_USER = '6666'; $PHP_AUTH_PW = 'rcspro';
...
$allowed_campaigns = "'".str_replace(" ", "', '", $allowed_campaigns)."'"; // try explode instead
